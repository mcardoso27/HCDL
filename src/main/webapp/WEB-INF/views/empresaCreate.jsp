        ...
        <div class="container">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <f:form action="empresaAdd.htm" modelAttribute="emp">
                    ...
                    <p>
                        ...
                        <f:input path="numeroEmpleados" cssClass="form-control"/>
                    </p>

                    <p id="parrafo">
                        <label for="art">Posee ART:</label>
                        <input id="art1" name="art" type="radio" value="true" checked="false">Si</input>
